...
### [ ] Validate Inbound Express Request Structures
...
### [ ] Configure Vitest Suite & Component Harnesses
...
- **Reference Files**: `/package.json`, `/vite.config.ts`
- **Target Effort**: Medium

### [ ] Standardize Environment Validation on Bootstrap
...
### [ ] Integrate Local AST Parser Core
...
- **Reference Files**: `/src/components/CccCompiler.tsx`, `/server.ts`
- **Target Effort**: High

### [ ] Implement Request Latency Instrumentation & APM
...
### [ ] Add Code-Snippet Visualizers in Tab Panes
...
### [ ] Persist Compiled States Across Browser Sessions
